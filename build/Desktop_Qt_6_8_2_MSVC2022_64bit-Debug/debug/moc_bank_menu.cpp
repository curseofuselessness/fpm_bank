...
static constexpr auto qt_meta_stringdata_ZN9Bank_menuE = QtMocHelpers::stringData(
    "Bank_menu"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Bank_menuE[] = {
...
Q_CONSTINIT const QMetaObject Bank_menu::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Bank_menuE.offsetsAndSizes,
    qt_meta_data_ZN9Bank_menuE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Bank_menuE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Bank_menu, std::true_type>
    >,
    nullptr
} };
...
void *Bank_menu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Bank_menuE.stringdata0))
